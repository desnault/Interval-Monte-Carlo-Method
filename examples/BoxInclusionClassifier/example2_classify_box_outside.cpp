/********************************************************************************************
 * @file    example2_classify_box_outside.cpp
 * @author  Damien ESNAULT (PhD student, ENSTA/Lab-STICC)
 * @date    2025
 * @brief   Example illustrating the BoxInclusionClassifier for a box fully outside the
 *          robot-covered area.
 *
 * @details
 ...
 * that the classifier correctly identifies a box that is fully outside the covered area.
 *
 ...
 *
 * Expected output:
 *   - The inclusion classifier should return [0] for this box (fully outside).
 ********************************************************************************************/
